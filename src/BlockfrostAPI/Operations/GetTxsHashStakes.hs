...
data GetTxsHashStakesResponse =
  ...
  | GetTxsHashStakesResponse200 TxContentStakeAddresses -- ^ Obtain information about (de)registration of stake addresses within a transaction. 
