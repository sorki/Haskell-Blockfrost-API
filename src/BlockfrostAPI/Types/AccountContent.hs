...
mkAccountContent :: GHC.Types.Bool -- ^ 'accountContentActive'
  ...
  -> AccountContent
mkAccountContent accountContentActive accountContentActiveEpoch accountContentControlledAmount accountContentPoolId accountContentReservesSum accountContentRewardsSum accountContentTreasurySum accountContentWithdrawableAmount accountContentWithdrawalsSum = AccountContent{accountContentActive = accountContentActive,
