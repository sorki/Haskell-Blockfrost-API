...
data TxContent = TxContent {
  ...
  -- | pool_retire_count: Count of the stake pool retirements within the transaction
  , txContentPoolRetireCount :: GHC.Integer.Type.Integer
  -- | pool_update_count: Count of the stake pool registrations and updates within the transaction
  ...
  -- | stake_cert_count: Count of the stake keys (de)registrations and delegations within the transaction
...
mkTxContent :: Data.Text.Internal.Text -- ^ 'txContentBlock'
  ...
  -> TxContent
mkTxContent txContentBlock txContentBlockHeight txContentDelegationCount txContentDeposit txContentFees txContentIndex txContentInvalidBefore txContentInvalidHereafter txContentOutputAmount txContentPoolRetireCount txContentPoolUpdateCount txContentSize txContentSlot txContentStakeCertCount txContentUtxoCount txContentWithdrawalCount = TxContent{txContentBlock = txContentBlock,
